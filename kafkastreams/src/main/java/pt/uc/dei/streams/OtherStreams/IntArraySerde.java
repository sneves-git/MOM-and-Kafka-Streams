package pt.uc.dei.streams.OtherStreams;
    ...
    public Serializer<int[]> serializer() {
        return new Serializer<int[]>() {
            ...
            public byte[] serialize(String string, int[] array) {
                /*
                 * from
                 * https://stackoverflow.com/questions/11665147/convert-a-longbuffer-intbuffer-
    ...
    public Deserializer<int[]> deserializer() {
        return new Deserializer<int[]>() {
            ...
            public int[] deserialize(String string, byte[] bytes) {
                /*
                 * from
                 * https://stackoverflow.com/questions/11437203/how-to-convert-a-byte-array-to-
                 * an-int-array
                 */
                if (bytes == null)
                    return null;
